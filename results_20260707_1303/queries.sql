...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Assignment Rule" AS prod_value, u."Enrolment Assignment Rule" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Modified Date" AS prod_value, u."Enrolment Modified Date" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Completion Date" AS prod_value, u."Enrolment Completion Date" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Status" AS prod_value, u."Enrolment Status" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Start Date" AS prod_value, u."Enrolment Start Date" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Is Enrolment Overdue" AS prod_value, u."Enrolment Is Enrolment Overdue" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Retrain Open Date" AS prod_value, u."Enrolment Retrain Open Date" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Retrain Date" AS prod_value, u."Enrolment Retrain Date" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Overdue Days" AS prod_value, u."Enrolment Overdue Days" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
...
SELECT "Enrolment Id", "CLIENT_NAME", "CLIENT_REGION", p."Enrolment Due Date" AS prod_value, u."Enrolment Due Date" AS uat_value
FROM PROD_DB.BI.LEARNING_ENROLMENT p
JOIN UAT_DB.BI.LEARNING_ENROLMENT u USING ("Enrolment Id", "CLIENT_NAME", "CLIENT_REGION")
WHERE NOT EQUAL_NULL(p."Enrolment Due Date", u."Enrolment Due Date")
LIMIT 5